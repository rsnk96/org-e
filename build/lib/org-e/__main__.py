...
class Window(QtWidgets.QMainWindow):
	...
	def __init__(self):
		...
		palette.setBrush(QtGui.QPalette.Background, QtGui.QBrush(QtGui.QPixmap(os.path.join('org-e','images','org-e bg.PNG'))))
...
def main():
	...
	app.setWindowIcon(QtGui.QIcon(os.path.join('org-e', 'images','org-e logo.png')))
	GUI = Window()
	sys.exit(app.exec_())
